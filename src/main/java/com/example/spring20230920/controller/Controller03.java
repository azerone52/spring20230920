...
public class Controller03 {
    ...
    // /main2/sub5?email=abc@gmail.com&gender=남자&number=010-9990
    @RequestMapping("sub5")
    ...
    //RequestParam이면 값을 꼭 받아야함->안받아도 되게하려면 required=false
    @RequestMapping("sub9")
    ...
    public void method10(@RequestParam("address") String addr,
