...
-- 예) 공급자의 이름(supplierName), 주소(address, city, country), 전화번호(phone number)
SELECT SupplierName, CONCAT(Address, ' ', City, ' ', Country) AS address, Phone `phone number` FROM suppliers;
