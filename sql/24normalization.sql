...
INSERT INTO my_table22_person (name, schools, skill1, skill2, skill3)
VALUE ('인재', '대학원', '배구', null, null);
SELECT * FROM my_table22_person;

-- 각 행의 데이터들이 원자적 값을 가진 테이블
...
-- 긱 행은 유일무이한 식별자인 기본키(primary key)를 가지고 있어야 한다.
...
-- 3. 기본키는 간결해야 함(하나의 컬럼이 best)
-- 4. 기본키의 값은 변경 불가함

CREATE TABLE my_table25_person (
    id INT NOT NULL UNIQUE AUTO_INCREMENT, -- 1부터 자동으로 증가된 값을 삽입
